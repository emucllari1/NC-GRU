...
class NCGRUCell(LayerRNNCell):
  ...
  def __init__(self, num_units, two_orthogonal, D = None, activation='modReLU', reuse=None, name=None, dtype=None):
    ...
    if two_orthogonal:
        self.UC_gate_kernel_initializer_one = tf.keras.initializers.he_uniform()
        self.UC_gate_kernel_initializer_two = tf.keras.initializers.he_uniform()
        self._WC_gate_kernel_initializer_two = tf.keras.initializers.he_uniform()
        self.gate_bias_initializer_one = tf.keras.initializers.random_normal(mean=0.0, stddev=1.0)
        self.gate_bias_initializer_two = tf.keras.initializers.random_normal(mean=0.0, stddev=1.0)
    else:
        self.gate_kernel_initializer = tf.keras.initializers.he_uniform()
        self.gate_bias_initializer = init_ops.zeros_initializer()

    self.UC_kernel_initializer = tf.keras.initializers.he_normal()
